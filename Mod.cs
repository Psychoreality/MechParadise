...
public static class Recipes
{
    ...
    public static class BossForgeRecipes
    {
        public override void AddRecipes()
        {
            ...
            recipe = new ModRecipe(mod);
            recipe.AddIngredient(null, "Martian Energy Core", 1);
            ...
            recipe = new ModRecipe(mod);
            recipe.AddIngredient(null, "Unhallowed Shard", 10);
            ...
            recipe = new ModRecipe(mod);
            recipe.AddIngredient(null, "Fishron Scale", 3);
            ...
            recipe.AddRecipe();
            recipe = new ModRecipe(mod);
            recipe.AddIngredient(null, "Fishron Scale", 6);
            ...
            recipe = new ModRecipe (mod);
            recipe.AddIngredient(null, "Lunar Heart", 1);
            ...
            recipe = new ModRecipe(mod);
            recipe.AddIngredient(null, "Heavy Petal", 5);
            ...
            recipe.AddTile(null, "BossForge");
            recipe = new ModRecipe(mod);
            recipe.AddIngredient(null, "Heavy Petal", 25);
